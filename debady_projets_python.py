...
def david():
    ...
    if (nom==""or numero==""):
        ...
        answer_erreur.config(text="attention inserer un nom")
    else:

        messagebox.showinfo("numero enregistre avec succes!!")
...
lab_nom=Label(debady,text="ENTREZ LE NOM : ",font=("arial",15),bg="white",fg="black")
...
lab_numero=Label(debady,text="ENTREZ LE NUMERO 8 CHIFFRE : ",font=("arial",15),bg="white",fg="black")
...
moov=PhotoImage(file="reseau//logo_moov.png")
answer_logo_moov=Label(debady,image=moov)
answer_logo_moov.place(x=485,y=240,width=165,height=150)
